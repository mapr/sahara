...
class MySQL(s.Service):
    ...
    def get_db_instance(context):
        oozie_instance = context.oozie_server
        spark_master = context.get_instance(spark.SPARK_MASTER)
        return oozie_instance or spark_master
