...
class Hive(s.Service):
    def __init__(self):
        ...
        self.name = 'hive'
        self.ui_name = 'Hive'
        self.node_processes = [HIVE_METASTORE, HIVE_SERVER_2]
    ...
    def get_config_files(self, cluster_context, configs, instance=None):
        ...
        hive_site.remote_path = '/opt/mapr/hive/hive-%s/conf/' % self.version
        if instance:
    ...
    def conf_dir(self, cluster_context):
        return '/opt/mapr/hive/hive-%s/conf' % self.version
...
class HiveV012(Hive):
    def __init__(self):
        ...
        self.version = '0.12'
        self.dependencies = [('mapr-hive', self.version)]
