...
class YARN(s.Service):
    ...
    def __init__(self):
        ...
        # FIXME: little misconception
        self.name = 'yarn'
        self.ui_name = 'YARN'
        self.node_processes = [RESOURCE_MANAGER, NODE_MANAGER, HISTORY_SERVER]
        self.cluster_mode = 'yarn'
        self.ui_info = [
        ...
        self.cluster_defaults = ['yarn-cluster.json']
        self.node_defaults = ['yarn-node.json']

    def get_config_files(self, cluster_context, configs, instance=None):
        # yarn-site.xml
        ys_remote = '/opt/mapr/hadoop/hadoop-%s/etc/hadoop/' % self.version
        yarn_site = bcf.HadoopXML("yarn-site.xml")
        yarn_site.remote_path = ys_remote
        if instance:
        ...
        cs_remote = '/opt/mapr/hadoop/hadoop-%s/etc/hadoop/' % self.version
        core_site.remote_path = cs_remote
        if instance:
