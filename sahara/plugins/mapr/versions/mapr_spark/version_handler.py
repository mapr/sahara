...
import sahara.plugins.mapr.versions.mapr_spark.context as c
from sahara.plugins.mapr.versions.mapr_spark import spark_engine as edp_engine
import sahara.plugins.mapr.versions.mapr_spark.spark_starter as cs
...
class VersionHandler(bvh.BaseVersionHandler):
    def __init__(self):
        ...
        self.node_manager = cs.SparkStarter()
